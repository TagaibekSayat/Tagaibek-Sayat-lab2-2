    public class Main {
        public static void main(String[] args) {
            Main Main = new Main();  Main.Info();
        }
        private static void Info() {
            String[] country = new String[10];
            country[0] = "Kazakhstan"; country[1] = "Uk"; country[2] = "Mexsico"; country[3] = "Kyrgistan";
            country[4] = "Uzbekistan"; country[5] = "Iran"; country[6] = " Sout Korea";
            country[7] = "Tailand"; country[8] = "USA"; country[9] = "Brazil";
